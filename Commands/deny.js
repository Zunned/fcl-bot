...
module.exports = {
    ...
    name: 'deny',
    description: 'Deny players into the group',
    data : new SlashCommandBuilder()
        .setName('deny')
        .setDescription('Deny players into the group')
    ...
    async slashexecute(bot, interaction) {
        ...
        .then(async(robloxid) => {
          ...
          rbxbot.handleJoinRequest(config.GroupID, robloxid, false)
           .then(() => interaction.reply(`Denied ${robloxname}s Request`))
        })
