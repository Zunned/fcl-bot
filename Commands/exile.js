...
module.exports = {
    ...
    name: 'exile',
    description: 'Kick players from the group',
    data : new SlashCommandBuilder()
        .setName('exile')
        .setDescription('Kick players from the group')
    ...
    async slashexecute(bot, interaction) {
        ...
        .then(async(robloxid) => {
          ...
          rbxbot.exile(config.GroupID, robloxid)
           .then(() => message.reply(`Exiled ${robloxname} from FCL`))
        })
